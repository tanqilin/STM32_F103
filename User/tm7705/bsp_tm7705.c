...
*/
	...
	#define RCC_RESET 	RCC_APB2Periph_GPIOE
...
// 通过电压,电流,功率判断用电器类型
uint8_t TM7705_Type(uint16_t u,uint16_t i){
	uint16_t u_dc = ((u * 5000) / 65535);
	uint16_t i_dc = ((i * 5000) / 65535)/1000;
	uint16_t p_dc = u_dc * i_dc;
