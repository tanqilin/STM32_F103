...
/*
	ESP8266_Rst ( );
	ESP8266_Cmd ( "AT+CWMODE=3", "OK", "ready", 2500 );
	ESP8266_Cmd ( "AT+CIFSR", "OK", "ready", 2500 );
	ESP8266_Cmd ( "AT+CIPMUX=1", "OK", "ready", 2500 );
	ESP8266_Cmd ( "AT+CIPSERVER=1,6060", "OK", "ready", 2500 );
*/
